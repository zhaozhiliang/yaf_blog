...
//        $db_config2['database_type'] = 'mysql';
//        $db_config2['username'] = 'root';
//        $db_config2['password'] = 'root';
//        $db_config2['database_name'] = 'yaf_blog';
//        $db_config2['port'] = '3306';
//        $db_config2['charset'] = 'utf8';
//        Yaf_Registry::set('db', new medoo($db_config2));
    }
    //载入缓存类rEDIS
